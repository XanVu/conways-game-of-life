...
var Organism = exports.default = /*#__PURE__*/function () {
  ...
  return _createClass(Organism, null, [{
    ...
    value: function startingLive(array) {
      for (var row = 0; row < array.length; row++) {
        for (var col = 0; col < array.length; col++) {
          ...
          array[row][col] = cell;
          _assertClassBrand(Organism, this, _setIterationCounter).call(this, cell);
        }
      }
      return array;
    }
    ...
    function initHtmlTable(array, size) {
      ...
      for (var row = 0; row < size; row++) {
        ...
        for (var col = 0; col < size; col++) {
          ...
          c.appendChild(span);
          _assertClassBrand(Organism, this, _setColorOfSpan).call(this, span, cell);
        }
      }
    ...
    key: "resetIterationCounter",
    value: function resetIterationCounter() {
...
function _setIterationCounter(cell) {
...
_organism.default.setSize(10);
var size = _organism.default.getSize();
_organism.default.initTable();
var table = _organism.default.getTable();
_organism.default.startingLive(table);
_organism.default.initHtmlTable(table, size);
function test() {
  return _test.apply(this, arguments);
}
function _test() {
  _test = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var organismIsDead, sleep, _table;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          if (!(!organismIsDead && _organism.default.getHasStarted() && !_organism.default.getHasStopped() && !_organism.default.getIsStable())) {
            _context.next = 15;
            break;
          }
          ...
          _organism.default.updateHtmlSpanInTable(_table);
          _organism.default.setHtmlStatValues();
        ...
        case 11:
          ...
          _organism.default.resetIterationCounter();
          _context.next = 2;
          break;
        case 15:
        case "end":
